...
#define BAT_IRQ_CFG_CHRG_DONE		BIT(2)
#define BAT_IRQ_CFG_CHRG_START		BIT(3)
#define BAT_IRQ_CFG_BAT_SAFE_EXIT	BIT(4)
#define BAT_IRQ_CFG_BAT_SAFE_ENTER	BIT(5)
#define BAT_IRQ_CFG_BAT_DISCON		BIT(6)
#define BAT_IRQ_CFG_BAT_CONN		BIT(7)
#define BAT_IRQ_CFG_BAT_MASK		0xFC

#define TEMP_IRQ_CFG_QCBTU		BIT(4)
#define TEMP_IRQ_CFG_CBTU		BIT(5)
#define TEMP_IRQ_CFG_QCBTO		BIT(6)
#define TEMP_IRQ_CFG_CBTO		BIT(7)
