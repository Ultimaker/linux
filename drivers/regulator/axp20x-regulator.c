...
#define AXP20X_GPIO0_FUNC_MASK		0x07

#define AXP22X_IO_ENABLED		0x03
#define AXP22X_IO_DISABLED		0x04

#define AXP20X_PWR_OUT_EXTEN_MASK	BIT(0)
#define AXP20X_PWR_OUT_DCDC3_MASK	BIT(1)
#define AXP20X_PWR_OUT_LDO2_MASK	BIT(2)
#define AXP20X_PWR_OUT_LDO4_MASK	BIT(3)
#define AXP20X_PWR_OUT_DCDC2_MASK	BIT(4)
#define AXP20X_PWR_OUT_LDO3_MASK	BIT(6)

#define AXP20X_DCDC2_LDO3_V_RAMP_DCDC2_RATE_MASK	BIT(0)
#define AXP20X_DCDC2_LDO3_V_RAMP_DCDC2_RATE(x) \
	((x) << 0)
#define AXP20X_DCDC2_LDO3_V_RAMP_LDO3_RATE_MASK		BIT(1)
#define AXP20X_DCDC2_LDO3_V_RAMP_LDO3_RATE(x) \
	((x) << 1)
#define AXP20X_DCDC2_LDO3_V_RAMP_DCDC2_EN_MASK		BIT(2)
#define AXP20X_DCDC2_LDO3_V_RAMP_DCDC2_EN		BIT(2)
#define AXP20X_DCDC2_LDO3_V_RAMP_LDO3_EN_MASK		BIT(3)
#define AXP20X_DCDC2_LDO3_V_RAMP_LDO3_EN		BIT(3)

#define AXP20X_DCDC2_V_OUT_MASK		0x3f
#define AXP20X_DCDC3_V_OUT_MASK		0x7f
#define AXP20X_LDO24_V_OUT_MASK		0xf0
#define AXP20X_LDO3_V_OUT_MASK		0x7f
#define AXP20X_LDO5_V_OUT_MASK		0xf0

#define AXP22X_PWR_OUT_DC5LDO_MASK	BIT(0)
#define AXP22X_PWR_OUT_DCDC1_MASK	BIT(1)
#define AXP22X_PWR_OUT_DCDC2_MASK	BIT(2)
#define AXP22X_PWR_OUT_DCDC3_MASK	BIT(3)
#define AXP22X_PWR_OUT_DCDC4_MASK	BIT(4)
#define AXP22X_PWR_OUT_DCDC5_MASK	BIT(5)
#define AXP22X_PWR_OUT_ALDO1_MASK	BIT(6)
#define AXP22X_PWR_OUT_ALDO2_MASK	BIT(7)

#define AXP22X_DCDC1_V_OUT_MASK		0x1f
#define AXP22X_DCDC2_V_OUT_MASK		0x3f
#define AXP22X_DCDC3_V_OUT_MASK		0x3f
#define AXP22X_DCDC4_V_OUT_MASK		0x3f
#define AXP22X_DCDC5_V_OUT_MASK		0x1f
#define AXP22X_DC5LDO_V_OUT_MASK	0x7
#define AXP22X_ALDO1_V_OUT_MASK		0x1f
#define AXP22X_ALDO2_V_OUT_MASK		0x1f
#define AXP22X_ALDO3_V_OUT_MASK		0x1f
#define AXP22X_DLDO1_V_OUT_MASK		0x1f
#define AXP22X_DLDO2_V_OUT_MASK		0x1f
#define AXP22X_DLDO3_V_OUT_MASK		0x1f
#define AXP22X_DLDO4_V_OUT_MASK		0x1f
#define AXP22X_ELDO1_V_OUT_MASK		0x1f
#define AXP22X_ELDO2_V_OUT_MASK		0x1f
#define AXP22X_ELDO3_V_OUT_MASK		0x1f
#define AXP22X_LDO_IO0_V_OUT_MASK	0x1f
#define AXP22X_LDO_IO1_V_OUT_MASK	0x1f

#define AXP22X_PWR_OUT_ELDO1_MASK	BIT(0)
#define AXP22X_PWR_OUT_ELDO2_MASK	BIT(1)
#define AXP22X_PWR_OUT_ELDO3_MASK	BIT(2)
#define AXP22X_PWR_OUT_DLDO1_MASK	BIT(3)
#define AXP22X_PWR_OUT_DLDO2_MASK	BIT(4)
#define AXP22X_PWR_OUT_DLDO3_MASK	BIT(5)
#define AXP22X_PWR_OUT_DLDO4_MASK	BIT(6)
#define AXP22X_PWR_OUT_ALDO3_MASK	BIT(7)

#define AXP22X_PWR_OUT_SW_MASK		BIT(6)
#define AXP22X_PWR_OUT_DC1SW_MASK	BIT(7)
...
#define AXP20X_VBUS_IPSOUT_MGMT_MASK	BIT(2)

#define AXP22X_MISC_N_VBUSEN_FUNC	BIT(4)

#define AXP806_PWR_OUT_DCDCA_MASK	BIT(0)
#define AXP806_PWR_OUT_DCDCB_MASK	BIT(1)
#define AXP806_PWR_OUT_DCDCC_MASK	BIT(2)
#define AXP806_PWR_OUT_DCDCD_MASK	BIT(3)
#define AXP806_PWR_OUT_DCDCE_MASK	BIT(4)
#define AXP806_PWR_OUT_ALDO1_MASK	BIT(5)
#define AXP806_PWR_OUT_ALDO2_MASK	BIT(6)
#define AXP806_PWR_OUT_ALDO3_MASK	BIT(7)
#define AXP806_PWR_OUT_BLDO1_MASK	BIT(0)
#define AXP806_PWR_OUT_BLDO2_MASK	BIT(1)
#define AXP806_PWR_OUT_BLDO3_MASK	BIT(2)
#define AXP806_PWR_OUT_BLDO4_MASK	BIT(3)
#define AXP806_PWR_OUT_CLDO1_MASK	BIT(4)
#define AXP806_PWR_OUT_CLDO2_MASK	BIT(5)
#define AXP806_PWR_OUT_CLDO3_MASK	BIT(6)
#define AXP806_PWR_OUT_SW_MASK		BIT(7)

#define AXP806_DCDCA_V_CTRL_MASK	0x7f
#define AXP806_DCDCB_V_CTRL_MASK	0x1f
#define AXP806_DCDCC_V_CTRL_MASK	0x7f
#define AXP806_DCDCD_V_CTRL_MASK	0x3f
#define AXP806_DCDCE_V_CTRL_MASK	0x1f
#define AXP806_ALDO1_V_CTRL_MASK	0x1f
#define AXP806_ALDO2_V_CTRL_MASK	0x1f
#define AXP806_ALDO3_V_CTRL_MASK	0x1f
#define AXP806_BLDO1_V_CTRL_MASK	0x0f
#define AXP806_BLDO2_V_CTRL_MASK	0x0f
#define AXP806_BLDO3_V_CTRL_MASK	0x0f
#define AXP806_BLDO4_V_CTRL_MASK	0x0f
#define AXP806_CLDO1_V_CTRL_MASK	0x1f
#define AXP806_CLDO2_V_CTRL_MASK	0x1f
#define AXP806_CLDO3_V_CTRL_MASK	0x1f
...
static int axp20x_regulator_enable_regmap(struct regulator_dev *rdev)
{
	...
	case AXP209_ID:
		if ((desc->id == AXP20X_LDO3) &&
			 ...
			 * works reliably. A small pause is needed between
...
static const struct regulator_desc axp20x_regulators[] = {
	...
	AXP_DESC_RANGES(AXP20X, LDO4, "ldo4", "ldo24in", axp20x_ldo4_ranges,
			16, AXP20X_LDO24_V_OUT, AXP20X_LDO24_V_OUT_MASK,
...
static const struct regulator_desc axp22x_regulators[] = {
	...
	AXP_DESC_IO(AXP22X, LDO_IO1, "ldo_io1", "ips", 700, 3800, 100,
		    ...
		    AXP20X_GPIO1_CTRL, AXP20X_GPIO0_FUNC_MASK,
		    AXP22X_IO_ENABLED, AXP22X_IO_DISABLED),
...
static const struct regulator_desc axp806_regulators[] = {
	AXP_DESC_RANGES(AXP806, DCDCA, "dcdca", "vina", axp806_dcdca_ranges,
			72, AXP806_DCDCA_V_CTRL, AXP806_DCDCA_V_CTRL_MASK,
	...
	AXP_DESC_RANGES(AXP806, CLDO2, "cldo2", "cldoin", axp806_cldo2_ranges,
			32, AXP806_CLDO2_V_CTRL, AXP806_CLDO2_V_CTRL_MASK,
...
static const struct regulator_desc axp809_regulators[] = {
	...
	AXP_DESC_RANGES(AXP809, DCDC4, "dcdc4", "vin4", axp809_dcdc4_ranges,
			57, AXP22X_DCDC4_V_OUT, AXP22X_DCDC4_V_OUT_MASK,
			AXP22X_PWR_OUT_CTRL1, AXP22X_PWR_OUT_DCDC4_MASK),
	...
	AXP_DESC_RANGES(AXP809, DLDO1, "dldo1", "dldoin", axp806_cldo2_ranges,
			32, AXP22X_DLDO1_V_OUT, AXP22X_DLDO1_V_OUT_MASK,
			AXP22X_PWR_OUT_CTRL2, AXP22X_PWR_OUT_DLDO1_MASK),
